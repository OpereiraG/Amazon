...
public class WrongUsernameAmazon {

    @Test
    public void failedUsername() throws InterruptedException {
        ...
        UserName.sendKeys("BugHunters29@gmail.com");
        WebElement clickContinue = driver.findElement(By.xpath("( //input[@class='a-button-input'])[1]"));
        clickContinue.click();
        WebElement actual = driver.findElement(By.xpath("//span[contains(text(),'We cannot find an account with that email address')]"));
